...
async function normalizeOptionsAsync(projectDir, options) {
  ...
  const opts = { ...options,
    ...
    webOnly: (_options$webOnly = options.webOnly) !== null && _options$webOnly !== void 0 ? _options$webOnly : await _xdl().Web.onlySupportsWebAsync(projectDir),
...
async function validateDependenciesVersions(projectDir, exp, pkg) {
  ...
  const bundleNativeModulesPath = (0, _attempt().default)(() => (0, _config().resolveModule)('expo/bundledNativeModules.json', projectDir, exp));
